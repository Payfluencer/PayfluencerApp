...
export const getWelcomeEmail = ({ message, url, btnLabel }: WelcomeEmail) => {
  return `
...
<head>
 ...
 <link href="https://fonts.googleapis.com/css?family=Fira+Sans:ital,wght@0,300;0,500;0,800" rel="stylesheet" />
 <title>Edutank</title>
 <!--[if !mso]><!-- -->
 <style>
 @media  all {
                   ...
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                    <tr>
                     <td valign="top" align="center">
                      <div class="pc-font-alt" style="line-height: 121%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 500; font-variant-ligatures: normal; color: #000a63; text-align: center; text-align-last: center;">
                       <div><span style="color: #000a63;">Welcome</span>
                       </div>
                      </div>
                     </td>
                    </tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                  <td align="center" valign="top" style="padding: 0px 0px 30px 0px;">
                   <img src="https://app.edutank.io/_next/image?url=%2Flogo.png&w=640&q=75" class="" width="285" height="57" alt="" style="display: block; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width:285px; height: auto; max-width: 100%; border: 0;" />
                  </td>
                 </tr>
                </table>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                  <td align="center" valign="top" style="padding: 0px 0px 30px 0px;">
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                    <tr>
                     <td valign="top" align="center">
                      <div class="pc-font-alt pc-w620-fontSize-30 pc-w620-lineHeight-133pc" style="line-height: 128%; letter-spacing: -0.6px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 24px; font-weight: 800; font-variant-ligatures: normal; color: #000a63; text-align: center; text-align-last: center;">
                       <div><span style="color: rgb(0, 10, 99);">AI Tool that boost your productivity.</span>
                       </div>
                      </div>
                     </td>
                    </tr>
                 ...
                 <tr>
                  <td align="center" valign="top" style="padding: 0px 0px 29px 0px;">
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                    <tr>
                     <td valign="top" align="center">
                      <div class="pc-font-alt pc-w620-fontSize-16 pc-w620-lineHeight-163pc" style="line-height: 156%; letter-spacing: -0.2px; font-family: 'Fira Sans', Arial, Helvetica, sans-serif; font-size: 18px; font-weight: 300; font-variant-ligatures: normal; color: #000a63; text-align: center; text-align-last: center;">
                       <div><span style="color: rgb(0, 10, 99);">${message}</span>
                       </div>
                      </div>
                     </td>
                    </tr>
